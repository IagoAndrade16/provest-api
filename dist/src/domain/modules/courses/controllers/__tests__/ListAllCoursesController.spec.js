...
describe("Create user controller", function () {
    ...
    it("should be able to list all courses", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).get("/courses").send()];
                case 1:
                    response = _a.sent();
