...
var AuthenticateUserUseCase = /** @class */ (function () {
    function AuthenticateUserUseCase(usersRepository, coursesRepository) {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMatch, expires_in_token, secret_token, user_courses, token, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new DomainError_1.DomainError("User does not exists!", 400);
                        }
                        return [4 /*yield*/, (0, bcryptjs_1.compare)(password, user.password)];
                    case 2:
                        passwordMatch = _b.sent();
                        if (!passwordMatch) {
                            throw new DomainError_1.DomainError("Incorrect password!", 400);
                        }
                        expires_in_token = auth_1.default.expires_in_token, secret_token = auth_1.default.secret_token;
