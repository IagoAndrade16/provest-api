...
exports.AlterUserUseCase = void 0;
var DomainError_1 = require("@errors/DomainError");
var tsyringe_1 = require("tsyringe");
var AlterUserUseCase = /** @class */ (function () {
    function AlterUserUseCase(usersRepository) {
        this.usersRepository = usersRepository;
    }
    AlterUserUseCase.prototype.execute = function (data, id) {
    ...
    AlterUserUseCase = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("UsersRepository")),
        __metadata("design:paramtypes", [Object])
    ], AlterUserUseCase);
    return AlterUserUseCase;
}());
exports.AlterUserUseCase = AlterUserUseCase;
